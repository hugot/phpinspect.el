...
;;           (setq children (thread-last (phpinspect-bmap-root-meta (phpinspect-pctx-bmap ctx))
;;                                       (phpinspect-meta-children)
;;                                       (phpinspect-splayt-to-list))
;;                 string-meta (car children))
...
;;         (let ((prev-string-meta (phpinspect-meta-first-child (phpinspect-bmap-root-meta (phpinspect-pctx-bmap ctx))))
;;               (ctx (phpinspect-make-pctx :incremental t
;;                                          :previous-bmap (phpinspect-pctx-bmap ctx)
;;                                          :bmap (phpinspect-make-bmap)
;;                                          :edtrack edit-tracker)))
;;           (phpinspect-with-parse-context ctx
;;             (phpinspect-parse-string "    : 'abc'      "))

;;           (let* ((children (thread-last (phpinspect-bmap-root-meta (phpinspect-pctx-bmap ctx))
;;                                         (phpinspect-meta-children)
;;                                         (phpinspect-splayt-to-list)))
;;                  (string-meta (car children)))
